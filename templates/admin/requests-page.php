        ...
        <div class="authdocs-pagination" id="authdocs-top-pagination">
            ...
            <div class="authdocs-pagination-links">
                ...
                <a href="<?php echo esc_url(add_query_arg('paged', $total_pages)); ?>"
                    class="page-numbers"><?php echo $total_pages; ?></a>
                <?php endif; ?>
                        ...
                        <tr data-request-id="<?php echo esc_attr($request->id); ?>"
                            ...
                            <td data-label="Document">
                                ...
                                <div class="authdocs-document-info">
                                    ...
                                    <a href="<?php echo esc_url(get_edit_post_link($request->document_id)); ?>"
                                        target="_blank">
                                    ...
                                    <br><small
                                        class="authdocs-status-note"><?php _e('Title not available', 'protecteddocs'); ?></small>
                                    <?php endif; ?>

                                    <?php if ($is_document_deactivated): ?>
                                    <div class="authdocs-document-notice">
                                        <span class="dashicons dashicons-warning"
                                            title="<?php _e('Document is currently deactivated', 'protecteddocs'); ?>"></span>
                                        <span
                                            class="authdocs-notice-text"><?php _e('Document deactivated', 'protecteddocs'); ?></span>
                                    </div>
                                    <?php endif; ?>
                                </div>
                            </td>
                            <td data-label="File Link">
                                ...
                                <div class="authdocs-file-status-modern authdocs-file-status-locked">
                                    ...
                                    <span
                                        class="authdocs-file-status-text"><?php _e('Locked', 'protecteddocs'); ?></span>
                                </div>
                                <?php
                                ...
                                <div class="authdocs-file-status-modern authdocs-file-status-pending">
                                    ...
                                    <span
                                        class="authdocs-file-status-text"><?php _e('Pending', 'protecteddocs'); ?></span>
                                </div>
                                <?php endif; ?>
                                <?php else: ?>
                                <div class="authdocs-file-status-modern authdocs-file-status-no-file">
                                    ...
                                    <span
                                        class="authdocs-file-status-text"><?php _e('No file', 'protecteddocs'); ?></span>
                                </div>
                                <?php endif; ?>
                            </td>
                            <td data-label="Status">
                                ...
                                <div class="authdocs-status-modern authdocs-status-<?php echo esc_attr($request->status); ?>"
                                    ...
                                    <span
                                        class="authdocs-status-text"><?php echo esc_html(ucfirst($request->status)); ?></span>
                                </div>
                            </td>
                            <td data-label="Date & Time">
                                <div class="authdocs-date-time">
                                    <div class="authdocs-date">
                                        <?php echo esc_html(date_i18n(get_option('date_format'), strtotime($request->created_at))); ?>
                                    </div>
                                    <div class="authdocs-time">
                                        <?php echo esc_html(date_i18n(get_option('time_format'), strtotime($request->created_at))); ?>
                                    </div>
                                </div>
                            </td>
                            <td data-label="Actions">
                                <div class="authdocs-request-actions">
                                    ...
                                    <!-- Accept Link -->
                                    <button type="button"
                                        class="authdocs-action-link authdocs-action-accept <?php echo $accept_disabled ? 'disabled' : ''; ?>"
                                    ...
                                    <!-- Decline Link -->
                                    <button type="button"
                                        class="authdocs-action-link authdocs-action-decline <?php echo $decline_disabled ? 'disabled' : ''; ?>"
                                    ...
                                    <button type="button"
                                        class="authdocs-action-link authdocs-action-inactive <?php echo $toggle_disabled ? 'disabled' : ''; ?>"
                                        ...
                                        <span
                                            class="dashicons <?php echo $request->status === 'inactive' ? 'dashicons-visibility' : 'dashicons-hidden'; ?>"></span>
                                    </button>
                ...
                <div class="authdocs-pagination" id="authdocs-pagination">
                    ...
                    <div class="authdocs-pagination-links">
                        ...
                        <a href="<?php echo esc_url(add_query_arg('paged', $i)); ?>"
                            class="page-numbers"><?php echo $i; ?></a>
                        <?php endif; ?>
                        <?php endfor; ?>
