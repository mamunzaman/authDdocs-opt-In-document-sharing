...
class LinkHandler
{
    ...
    private function render_error(string $message, int $status_code): void
    {
        ...
        <head>
            <meta charset="UTF-8">
            <meta name="viewport" content="width=device-width, initial-scale=1.0">
            <title>Error - AuthDocs</title>
            <style>
                body { font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 50px auto; padding: 20px; }
                .error-box { background: #f8d7da; border: 1px solid #f5c6cb; border-radius: 8px; padding: 30px; text-align: center; }
                .error-icon { font-size: 48px; color: #721c24; margin-bottom: 20px; }
                h1 { color: #721c24; margin: 0 0 20px 0; }
                p { margin: 0 0 15px 0; }
                .back-link { margin-top: 30px; }
                .back-link a { color: #007cba; text-decoration: none; }
                .back-link a:hover { text-decoration: underline; }
